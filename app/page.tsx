  ...
  const services = [
    {
      ...
      description: "Innovative blockchain solutions for secure, decentralized applications.",
    ...
    },
    {
      ...
      description: "Powerful online stores that drive sales and enhance customer experiences.",
    ...
    },
    {
      ...
      description: "Robust web applications built with the elegant Laravel framework.",
    ...
    },
    {
      ...
      description: "Versatile Python solutions for web, data science, AI, and automation.",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
              >
                <h3 className={`text-2xl font-semibold mb-4 ${service.textColor}`}>{service.title}</h3>
