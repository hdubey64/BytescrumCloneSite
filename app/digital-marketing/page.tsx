...
export default function DigitalMarketingPage() {
   ...
   const contentServices = [
      ...
      },
      {
         title: "Copywriting",
         description:
            "Craft compelling copy that drives action and conversions.",
         icon: "carbon:text",
      },
      {
         title: "Video Content",
      ...
      },
      {
         title: "Infographics",
         description:
            "Create visual content that simplifies complex information.",
            ...
            >
               <div className="container mx-auto px-4">
                  ...
                  >
                     ...
                     >
                        Drive growth with data-driven strategies that increase
                        visibility, engage your audience, and generate leads
                     </motion.p>
                     <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                     ...
                     {services.map((service, index) => (
                        <motion.div
                           ...
                           whileHover={{
                              y: -5,
                              boxShadow:
                                 "0 10px 30px -15px rgba(59, 130, 246, 0.5)",
                           }}
                        >
            ...
            <section ref={sectionRefs.strategies} className="py-20 bg-black">
               <div className="container mx-auto px-4">
                  ...
                  >
                     ...
                     <p className="text-gray-300">
                        We develop customized strategies to achieve your
                        specific business objectives and drive measurable
                        results.
                     </p>
                  </motion.div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                     {strategies.map((strategy, index) => (
                        ...
                        >
                           {/* Background number */}
                           <div
                              className={`absolute -top-10 -right-10 text-9xl font-bold text-${strategy.color}-500/10`}
                           >
                              {index + 1}
                           </div>
                           <h3
                              className={`text-2xl font-semibold mb-4 text-${strategy.color}-400 relative z-10`}
                           >
                              {strategy.title}
                           </h3>
               ...
               <div className="container mx-auto px-4">
                  ...
                  >
                     ...
                     <p className="text-gray-300">
                        ...
                        results and drive organic traffic to your business.
                     </p>
                  </motion.div>

                  <div className="flex justify-center mb-12 overflow-x-auto pb-4">
                     <div className="flex space-x-2 bg-gray-900/50 p-1 rounded-lg">
                        {["seo", "social", "content", "analytics"].map(
                           (tab) => (
                              <button
                                 key={tab}
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                     ...
                     >
                        ...
                        <p className="text-gray-300 mb-8">
                           Build brand awareness, engage with your audience, and
                           drive conversions through strategic social media
                           marketing.
                        </p>
            ...
            >
               <div className="container mx-auto px-4">
                  ...
                  >
                     ...
                     <p className="text-gray-300">
                        Create valuable, relevant content that attracts and
                        engages your target audience, establishing your brand as
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                           {[
                              ...
                              <motion.div
                                 ...
                                 whileHover={{
                                    y: -5,
                                    boxShadow: `0 10px 30px -15px rgba(var(--${item.color}-rgb), 0.3)`,
                                 }}
                              >
                                 <div
                        ...
                        <div className="space-y-4">
                           {[
                              ...
                              >
                                 ...
                                 >
                                    <span
                                       className={`iconify text-${benefit.color}-400 text-lg`}
               ...
               <div className="container mx-auto px-4">
                  ...
                  >
                     ...
                     <p className="text-gray-300">
                        ...
                        and make data-driven decisions to optimize your
                        strategies.
                     </p>
                  </motion.div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                     ...
                     >
                        ...
                        <p className="text-gray-300 mb-8">
                           ...
                           performance, helping you make informed decisions and
                           optimize your strategies for maximum ROI.
                        </p>
            ...
            >
               <div className="container mx-auto px-4">
                  ...
                  >
                     ...
                     <p className="text-gray-300">
                        See how our digital marketing strategies have helped
                        businesses achieve their goals and drive measurable
                        results.
                     </p>
                  </motion.div>
            ...
            <section ref={sectionRefs.platforms} className="py-20 bg-black">
               <div className="container mx-auto px-4">
                  ...
                  >
                     ...
                     <p className="text-gray-300">
                        We leverage the most effective platforms and tools to
                        execute your digital marketing strategies and achieve
                        your business goals.
                     </p>
                  </motion.div>
               ...
               <div className="container mx-auto px-4">
                  ...
                  >
                     ...
                     <p className="text-gray-300">
                        ...
                        marketing services and how we can help your business
                        grow.
                     </p>
                  </motion.div>
            ...
            <section className="py-20 bg-black">
               <div className="container mx-auto px-4">
                  ...
                  >
                     ...
                     <p className="text-gray-300">
                        Discover our full range of services to help your
               ...
               <div className="container mx-auto px-4 relative z-10">
                  ...
                  >
                     ...
                     <motion.p
                        ...
                        transition={{ duration: 0.5, delay: 0.2 }}
                     >
                        Let's discuss how our digital marketing strategies can
                        help you achieve your business goals and drive
                        measurable results.
                     </motion.p>
                     <motion.button
